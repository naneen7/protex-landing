    ...
    return (
        ...
        >
            <div
                ...
                style={{
                    background: 'radial-gradient(circle closest-side, rgba(83, 219, 120, 0.15), transparent)',
                }}
            />
...
export default function Features() {
    const cards = [
        {
            image: 'https://cdn.prod.website-files.com/68d83f72d281eefaf4a62163/68fb83b433a04ccd71234cec_object-1.svg',
        ...
        {
            image: 'https://cdn.prod.website-files.com/68d83f72d281eefaf4a62163/68fb86ae9623b87aa0f83987_object-2.svg',
        ...
        {
            image: 'https://cdn.prod.website-files.com/68d83f72d281eefaf4a62163/690bd9a2d795d586c8a98713_object-3.svg',
            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
                    <motion.div
                        ...
                        className="md:w-1/2"
                    >
                        <div className="text-[#53db78] text-sm font-semibold tracking-wide uppercase mb-4">Features</div>
                        <h2 className="text-4xl md:text-5xl font-bold text-white tracking-tight">Build to protect every layer</h2>
                    </motion.div>
                    <motion.div
                        initial={{ opacity: 0, x: 20 }}
                        whileInView={{ opacity: 1, x: 0 }}
