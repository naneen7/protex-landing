    ...
    <nav className="fixed w-full z-50 py-4 px-6 top-0 backdrop-blur-md bg-[#000d01]/80 border-b border-white/10">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8 text-sm font-medium">
          <a href="#Features" className="text-white hover:text-white/70 transition-colors">Features</a>
          <a href="#Capabilities" className="text-white hover:text-white/70 transition-colors">Capabilities</a>
          <a href="#How-it-works" className="text-white hover:text-white/70 transition-colors">How it works</a>
          <a href="#Pricing" className="text-white hover:text-white/70 transition-colors">Pricing</a>
        </div>
