...
export default function Logos() {
    const logos = [
        { src: 'https://cdn.prod.website-files.com/68d83f72d281eefaf4a62163/68fb75967292bc3f3abdc508_client-logo-1.svg', alt: 'Zunapulse' },
        { src: 'https://cdn.prod.website-files.com/68d83f72d281eefaf4a62163/68fb75a60b4fcd7cd3a5cc5f_client-logo-2.svg', alt: 'Flowbyte' },
        { src: 'https://cdn.prod.website-files.com/68d83f72d281eefaf4a62163/68fb75b3161664e9de07d9ee_client-logo-3.svg', alt: 'CipherCloud' },
        { src: 'https://cdn.prod.website-files.com/68d83f72d281eefaf4a62163/68fb75beaa0f1f049d57a9ec_client-logo-4.svg', alt: 'Novastack' },
    ];
