...
export default function Testimonials() {
    ...
    const Card = ({ item }: { item: any }) => {
        ...
        return (
            <div
                ref={cardRef}
                className="relative overflow-hidden shrink-0 w-[340px] sm:w-[400px] rounded-2xl bg-[#0a160d] border border-white/5 p-6 sm:p-8 flex flex-col group mx-3"
            >
                <div
                    ref={glowRef}
                ...
                <div className="relative z-10 flex flex-col h-full">
                    ...
                    <p className="text-base sm:text-lg text-gray-300 leading-relaxed whitespace-normal">{item.text}</p>
                </div>
            </div>
        );
    };
